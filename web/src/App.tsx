...
function RootRedirect() {
  return <Navigate to="/olimpo" replace />;
}
...
const BUILTIN_ROUTES_CORE: Record<string, ComponentType> = {
  ...
  "/olimpo": OlimpoPage,
  "/voice": VoicePage,
  "/connect": function ConnectRedirect() {
...
const BUILTIN_NAV_REST: NavItem[] = [
  { path: "/olimpo", label: "Inicio", icon: Landmark },
  { path: "/files", label: "Contexto", icon: FolderOpen },
  { path: "/models", label: "Modelos", icon: Cpu },
  { path: "/logs", label: "Errores", icon: FileText },
  ...
  { path: "/panteon", label: "Panteon", icon: Users },
  { path: "/env", label: "Keys", icon: KeyRound },
  { path: "/system", label: "Sistema", icon: Wrench },
];
