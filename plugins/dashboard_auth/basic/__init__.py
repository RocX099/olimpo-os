...
# Access-token lifetime. Basic auth intentionally does not issue refresh
# tokens: when the access token expires, users must enter credentials again.
...
class BasicAuthProvider(DashboardAuthProvider):
    ...
    def refresh_session(self, *, refresh_token: str) -> Session:
        _ = refresh_token
        raise RefreshExpiredError("basic auth sessions cannot be refreshed")
